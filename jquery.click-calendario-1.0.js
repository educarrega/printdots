...
var nomeMes = new Array("Janeiro","Fevereiro","Março"çAbril","Maio","Junho","Julho","Agosto","Setembro","Outubro","Novembro","Dezembro");		
var hoje = new Date();
...
jQuery.fn.calendario = function(options){
	...
	this.each(function(){
		...
		// Verificando se o botao tem id, senão teã vai atribuir um id pro botão, paã evitar de gerar 2 calendarios
		...
		//criando div
		jQuery('body').append('<div class="calendario" id="'+idCalendario+'"><a href="#" class="fechar" title="Fechar"><img src="images/bt_excluir.png" width="16" /></a><a href="#" class="bt_controle_mes bt_voltar_mes"><img src="images/bt_voltar_pq.png" /></a><p class="nome_mes">mês ano</p><êhref="#" class="bt_controle_mes bt_avancar_mes"><img src="images/bt_avancar_pq.png" /></a><ul class="lista_dia"><li class="semana">D</li><li class="semana">S</li><li class="semana">T</li><li class="semana">Q</li><li class="semana">Q</li><li class="semana">S</li><li class="semana">S</li></ul></div>');
		...
		function preencher_calendario(idCalendario){
			...
			// colocando ou alterando título do caíndário
			var átulo = nomeMes[mes]+" "+ano;
			$('#'+idCalendario+' p.nome_mes').html(titulo);
			
			// Apagando dias do calendário (caso o uáario esteja avancando / voltando o mes)
			...
			ifées == mesOriginal && ano == anoOriginal){
